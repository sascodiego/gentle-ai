...
func TestResolveAgentInstall(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:    "claude-code on darwin uses pnpm without sudo",
			profile: system.PlatformProfile{OS: "darwin", PackageManager: "brew"},
			agent:   model.AgentClaudeCode,
			want:    CommandSequence{{"pnpm", "install", "-g", "--ignore-scripts", "@anthropic-ai/claude-code@" + versions.ClaudeCode}},
		},
		{
			name:    "claude-code on linux system pnpm uses sudo",
			profile: system.PlatformProfile{OS: "linux", LinuxDistro: system.LinuxDistroUbuntu, PackageManager: "apt"},
			agent:   model.AgentClaudeCode,
			want:    CommandSequence{{"sudo", "pnpm", "install", "-g", "--ignore-scripts", "@anthropic-ai/claude-code@" + versions.ClaudeCode}},
		},
		{
		...
		{
			name:    "claude-code on arch system pnpm uses sudo",
			profile: system.PlatformProfile{OS: "linux", LinuxDistro: system.LinuxDistroArch, PackageManager: "pacman"},
			agent:   model.AgentClaudeCode,
			want:    CommandSequence{{"sudo", "pnpm", "install", "-g", "--ignore-scripts", "@anthropic-ai/claude-code@" + versions.ClaudeCode}},
		},
		...
		{
			name:    "opencode on ubuntu system pnpm uses sudo",
			profile: system.PlatformProfile{OS: "linux", LinuxDistro: system.LinuxDistroUbuntu, PackageManager: "apt"},
			agent:   model.AgentOpenCode,
			want:    CommandSequence{{"sudo", "pnpm", "install", "-g", "--ignore-scripts", "opencode-ai@" + versions.OpenCode}},
		},
		{
			name:    "opencode on ubuntu nvm skips sudo",
			profile: system.PlatformProfile{OS: "linux", LinuxDistro: system.LinuxDistroUbuntu, PackageManager: "apt", PnpmWritable: true},
			agent:   model.AgentOpenCode,
			want:    CommandSequence{{"pnpm", "install", "-g", "--ignore-scripts", "opencode-ai@" + versions.OpenCode}},
		},
		{
			name:    "opencode on arch system pnpm uses sudo",
			profile: system.PlatformProfile{OS: "linux", LinuxDistro: system.LinuxDistroArch, PackageManager: "pacman"},
			agent:   model.AgentOpenCode,
			want:    CommandSequence{{"sudo", "pnpm", "install", "-g", "--ignore-scripts", "opencode-ai@" + versions.OpenCode}},
		},
		{
			name:    "opencode on fedora system pnpm uses sudo",
			profile: system.PlatformProfile{OS: "linux", LinuxDistro: system.LinuxDistroFedora, PackageManager: "dnf"},
			agent:   model.AgentOpenCode,
			want:    CommandSequence{{"sudo", "pnpm", "install", "-g", "--ignore-scripts", "opencode-ai@" + versions.OpenCode}},
		},
		...
		{
			name:    "claude-code on windows uses pnpm without sudo",
			profile: system.PlatformProfile{OS: "windows", PackageManager: "winget", PnpmWritable: true},
			agent:   model.AgentClaudeCode,
			want:    CommandSequence{{"pnpm", "install", "-g", "--ignore-scripts", "@anthropic-ai/claude-code@" + versions.ClaudeCode}},
		},
		{
			name:    "opencode on windows uses pnpm without sudo",
			profile: system.PlatformProfile{OS: "windows", PackageManager: "winget"},
			agent:   model.AgentOpenCode,
			want:    CommandSequence{{"pnpm", "install", "-g", "--ignore-scripts", "opencode-ai@" + versions.OpenCode}},
		},
