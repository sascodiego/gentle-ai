...
func TestInstallCommand(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want:    [][]string{{"pnpm", "install", "-g", "--ignore-scripts", "@qwen-code/qwen-code@" + versions.QwenCode}},
		},
		{
			name:    "linux system pnpm uses sudo",
			profile: system.PlatformProfile{OS: "linux", LinuxDistro: system.LinuxDistroUbuntu, PackageManager: "apt"},
			want:    [][]string{{"sudo", "pnpm", "install", "-g", "--ignore-scripts", "@qwen-code/qwen-code@" + versions.QwenCode}},
		},
		{
